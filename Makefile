...
#    Updated: 2023/07/15 16:44:51 by absalem          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS			=	ft_isalnum.c ft_isprint.c   \
					ft_strlcat.c ft_strncmp.c   ft_isalpha.c \
					 ft_memcpy.c     ft_strlcpy.c ft_strchr.c\
					ft_tolower.c ft_bzero.c   ft_isascii.c  \
					    ft_strlen.c  ft_memmove.c ft_strrchr.c\
					ft_toupper.c   ft_isdigit.c  ft_memset.c  \
					ft_memchr.c ft_memcmp.c ft_atoi.c ft_strnstr.c\
					ft_calloc.c ft_substr.c ft_strdup.c ft_putstr_fd.c\
